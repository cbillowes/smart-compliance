...
def distance_metrics_form():
    with st.sidebar.expander("Step 2: Choose your distance metrics"):
        st.session_state["distance_metrics"] = st.multiselect(
...
def selfie_form():
    ...
    with st.expander("Selfie"):
        ...
        if kyc.selfie != None:
            ...
            distance_metrics = st.session_state["distance_metrics"]
            ...
            cols_results[0].write(verify_face(
                kyc.base_image, kyc.base_image, models, distance_metrics))
